...
const experience = [
  {
    ...
    logo: "https://essucalgary.com/images/teams/ssrt/ssrt.png",
    location: "Calgary, AB",
    tags: ["Robotics", "Networks", "Motors"],
    description:"• Contributing to the development of autonomous rover systems for robotics competitions.",
    buttonText: "View Team Website",
    buttonLink: "http://www.ssrt.ca/",
  ...
  },
  {
    id: 2,
    company: "Tech Start",
    logo: "https://avatars.githubusercontent.com/u/79076481?s=200&v=4",
    role: "AI & Frontend Developer",
    location: "Calgary, AB",
    tags: ["AI", "User Research", "Analytics", "TypeScript"],
    description:
    "• Developing an AI-powered communication coaching application for Toastmasters to enhance communication skills and performance.",
    buttonText: "View Organization's Website",
    buttonLink: "https://techstartucalgary.com/",
    date: "Nov 2025 - Present",
    icon: "extracurricular",
  },
  {
    id: 3,
    company: "ZeroKey",
    logo: "https://d2q79iu7y748jz.cloudfront.net/s/_squarelogo/256x256/7ec17f35ffc7efff183a69c30162b9e6",
